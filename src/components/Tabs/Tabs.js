...
{renderTabtitle(PICK_YOUR_PRICE,
     ...
     <div className="tab-2-content-top">
      <p className="text-lg">
        Watch TV shows and movies anytime, anywhere - personailzed for you.
      </p>
      <Link to='/netflix-show' className='btn btn-lg'>
        Watch Free for 30 days
      </Link>
    ...
    <div className="tab-2-content-bottom">
      <div>
        <img src='https://i.ibb.co/R3r1SPX/tab-content-2-1.png' alt=""/>
        <p className="text-md">
          Watch on your TV
        </p>
      ...
      <div>
      <img src='https://i.ibb.co/R3r1SPX/tab-content-2-3.png' alt=""/>
        <p className="text-md">
          Use any computer
        </p>
        <p className="text-dark">
       ...
       {activeTabName===PICK_YOUR_PRICE&&(
        <section className='tab-content'>
         ...
         <table className="table">
          ...
          <tbody>
            <tr>
              <td>Monthly price after free month ends on 05/30/2023</td>
              <td>$6.99</td>
              <td>$11.99</td>
              <td>$15.99</td>
            </tr>
